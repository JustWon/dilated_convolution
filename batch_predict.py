...
def main():
    ...
    for n, content in enumerate(contents):
        input_image = os.path.join('/home/dongwonshin/Desktop/Datasets/benchmark_RELEASE/dataset/img',content[:-1]+'.jpg')
        output_image =  os.path.join('batch_results/',content[:-1]+'.png')
        # print(input_image)
        # print(output_image)
        predict('pascal_voc', input_image, output_image)
        # if (n>10): break
